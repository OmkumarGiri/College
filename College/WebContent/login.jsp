...
<body>
	<a href="index.html">Home</a>>><a href="Log.html">Login</a>>><a href="login.html">Admin Login</a>
	<br>
	<div class="login">

		<form method="post" action="LoginServ" class="container">
			<h1>Log In</h1>
			<img src="adm.png"	alt="admin image" style="margin-bottom:10px;border-radius:110px;">
